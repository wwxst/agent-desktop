import type { StepId, ToolCallId, TurnId } from '@agent-desktop/model';

export type { StepId, ToolCallId, TurnId };
...
export interface AssistantMessageEvent { readonly type: 'assistant.message'; readonly turnId: TurnId; readonly stepId: StepId; readonly content?: string; readonly toolCalls: readonly { readonly id: ToolCallId; readonly name: string; readonly input: unknown }[]; readonly timestamp?: string; }
