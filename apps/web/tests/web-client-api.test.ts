...
describe('Web Dev API', () => {
  it('keeps sessions and emits a simulated tool, live text, and artifact result', async () => {
    ...
    expect(events).toEqual(['tool.started', 'text.delta', 'text.delta', 'tool.completed']);
